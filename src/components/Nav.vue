<template>
  <aside v-if="!isLoginPage" class="w-64 bg-white shadow-md border-r border-gray-200 flex flex-col py-6 overflow-y-auto"
    ...
    <nav class="flex-1 px-4 space-y-2">
      <router-link to="/" class="flex items-center px-4 py-2 rounded-md text-sm font-medium" :class="{
      ...
      <router-link to="/applicant" class="flex items-center px-4 py-2 rounded-md text-sm font-medium" :class="{
      ...
      <div class="w-full">
        ...
        <transition name="slide">
          <div v-if="jobsOpen" class="pl-6 mt-1 space-y-1 text-sm text-gray-600">
            <router-link to="/jobs/job_posting" class="flex items-center px-4 py-2 rounded-md" :class="{
              'bg-green-700 text-white': currentPath === '/jobs/job_posting',
              'text-gray-500 hover:bg-gray-100': currentPath !== '/jobs/job_posting'
            }">
              <i class="fas fa-file-alt mr-3"></i>
              Job Posts
            </router-link>
            <router-link to="/jobs/job_title" class="flex items-center px-4 py-2 rounded-md" :class="{
              'bg-green-700 text-white': currentPath === '/jobs/job_title',
              'text-gray-500 hover:bg-gray-100': currentPath !== '/jobs/job_title'
            }">
              <i class="fas fa-tag mr-3"></i>
              Job Titles
            </router-link>
            <router-link to="/jobs/job_category" class="flex items-center px-4 py-2 rounded-md" :class="{
              'bg-green-700 text-white': currentPath === '/jobs/job_category',
              'text-gray-500 hover:bg-gray-100': currentPath !== '/jobs/job_category'
            }">
      ...
      <router-link to="/request-leave" class="flex items-center px-4 py-2 rounded-md text-sm font-medium" :class="{
      ...
      <div class="w-full">
        ...
        <transition name="slide">
          <div v-if="settingOpen" class="pl-6 mt-1 space-y-1 text-sm text-gray-600">
            <router-link to="/users/roles" class="flex items-center px-4 py-2 rounded-md" :class="{
            ...
            <router-link to="/users/department" class="flex items-center px-4 py-2 rounded-md" :class="{
              'bg-green-700 text-white': currentPath === '/users/department',
              'text-gray-500 hover:bg-gray-100': currentPath !== '/users/department'
            }">
              <i class="fas fa-building mr-3"></i>
              Department
            </router-link>
            <router-link to="/users/user-management" class="flex items-center px-4 py-2 rounded-md" :class="{
              'bg-green-700 text-white': currentPath === '/users/user-management',
              'text-gray-500 hover:bg-gray-100': currentPath !== '/users/user-management'
            }">
