      ...
      <form @submit.prevent="handleLogin" class="space-y-4">
        ...
        <div>
          ...
          <div class="relative mt-1">
            ...
            <button type="button" class="absolute right-3 top-2.5 text-gray-500 focus:outline-none"
          ...
          <div class="mt-1 text-right">
            <RouterLink to="/forgot-password" class="text-sm text-[#2e6d56] hover:underline">Forget password?
            </RouterLink>
          </div>
        </div>

        <button type="submit"
          class="w-full cursor-pointer bg-[#2e6d56] text-white py-2 rounded-md hover:bg-[#245c48] transition text-sm font-medium">
          Login
        </button>
      </form>
